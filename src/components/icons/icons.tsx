...
export const MarketIcon = () => (
  <svg width="21" height="21" viewBox="0 0 62 52" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect y="12" width="24" height="40" rx="5" stroke="currentColor" strokeWidth="12" mask="url(#path-2-inside-2_29_148)" />
    <mask id="path-3-inside-3_29_148" fill="white">
      <rect x="19" width="24" height="52" rx="5" />
    </mask>
    <rect x="19" width="24" height="52" rx="5" stroke="currentColor" strokeWidth="12" mask="url(#path-3-inside-3_29_148)" />
